...
class Rapport(Base):
    ...
    format          = Column(SAEnum(FormatRapport, name="format_rapport_enum"), default=FormatRapport.PDF, nullable=False)
    type_generation = Column(SAEnum(TypeGeneration, name="type_generation_enum"), default=TypeGeneration.MANUEL, nullable=False)
